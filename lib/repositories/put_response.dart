...
Future<String> putImageResponse({required String url, required Map<String, String> payload, required String? photoPath, required String token}) async {
  Uri uriUrl = Uri.parse(url);

  final Map<String, String> header = {'Authorization': 'Bearer $token'};

  try {
    var request = http.MultipartRequest('PUT', uriUrl);
